...
en adelante, {genre.quotedElCliente},
...
{genre.ElCliente} y la PROVEEDORA, en adelante, podrán ser denominadas,
...
PRIMERO: Que {genre.elCliente} tiene interés en la contratación de:
...
TERCERO: Que las Partes están interesadas en celebrar un contrato de Mantenimiento en virtud del cual la PROVEEDORA preste {genre.alCliente} los servicios de:
...
En virtud del Contrato la PROVEEDORA se obliga a prestar {genre.alCliente} los servicios de mantenimiento de hardware, software y de red solicitados, en adelante los “SERVICIOS”, en los términos y condiciones previstos en el Contrato y en todos sus Anexos.
...
así como cualesquiera operaciones físicas y jurídicas que conlleve, salvo el Impuesto sobre el Valor Añadido (IVA) o su equivalente, que la PROVEEDORA repercutirá {genre.alCliente}.

2.1.4. La PROVEEDORA guardará confidencialidad sobre la información que le facilite {genre.elCliente} en o para la ejecución del Contrato o que por su propia naturaleza deba ser tratada como tal.
Se excluye de la categoría de información confidencial toda aquella información que sea divulgada por {genre.elCliente},
...
A tal efecto, se obliga a indemnizar {genre.alCliente}, 
...
A los efectos del artículo 12 de la Ley 15/1999, la PROVEEDORA únicamente tratará los datos de carácter personal a los que tenga acceso conforme a las instrucciones {genre.delCliente} y no 
...
2.1.6. La PROVEEDORA responderá de la corrección y precisión de los documentos que aporte {genre.alCliente} en ejecución del Contrato y avisará sin dilación {genre.alCliente} cuando detecte un error para que 
...
y subcontratistas, por lo que la PROVEEDORA responderá frente {genre.alCliente} si tales obligaciones son incumplidas por tales empleados.

2.1.8. {genre.ElCliente} podrá obtener de la PROVEEDORA las especificaciones de su instalación, si lo requiere.
...
a) Mantenimiento de HARDWARE:
	...
	- **Mantenimiento correctivo** que incluye
		...
		todo ello a cargo {genre.delCliente},
...
para el correcto funcionamiento del sistema instalado en {genre.elCliente},
...
2.2.2. {genre.ElCliente} facilitará la labor de la PROVEEDORA en todo momento
...
será por cuenta {genre.delCliente},
...
por la incorrecta manipulación de los componentes realizados por {genre.elCliente} o terceros no vinculados.

2.2.4. {genre.ElCliente} se compromete a utilizar
...
mediante llamada telefónica al ({proveedor.contact.phone[0]}) o correo electrónico a {proveedor.contact.email[1]}.
Las vísperas de festivos nacionales, el horario de atención telefónica será de 9 a 15 horas.
Los fines de semana o festivos, el servicio estará disponible a través del correo electrónico {proveedor.contact.email[1]}.
Cualquiera incidencia que se produzca, {genre.elCliente} deberá comunicarla a la PROVEEDORA,
...
3.1.
	{genre.ElCliente} es el único responsable de determinar
	...
	se ajuste a las necesidades específicas {genre.delCliente}.

3.2.
	{genre.ElCliente} se obliga a hacer constar de forma clara, visible y accesible desde sus contenidos,
...
3.3.
	{genre.ElCliente} se compromete a no hacer un uso de la red que altere por sobrecarga o saturación,
	...
	La PROVEEDORA se compromete a informar {genre.alCliente}, si lo pide,
	si un servicio está siendo  modulado o bloqueado e informar de las alternativas.

3.4.
	{genre.ElCliente} se compromete
...
3.5.
	La PROVEEDORA no se hará responsable de las acciones o conductas {genre.delCliente}
...
3.6.
	Tanto {genre.cliente} como PROVEEDOR, se comprometen a subscribir las condiciones de
...
4.3. **No atadura a la PROVEEDORA:**
	La PROVEEDORA se compromete a que {genre.elCliente} pueda acceder, si lo pide,
	...
	Los dispositivos instalados que consten en la factura como pagados quedan en propiedad {genre.delCliente}.
	{genre.ElCliente} garantizará a la PROVEEDORA el acceso físico y telemático
...
4.4. **Software libre:**
	La PROVEEDORA se compromete con {genre.elCliente} a que todos los aplicativos informáticos que desarrollen
	se  publicarán bajo una licencia libre según la definición de la Open Source Initiative.
	También se compromete a desempeñar su actividad con relación {genre.alCliente},
...
4.5. **Formatos abiertos:**
	La PROVEEDORA se compromete a comunicarse con {genre.elCliente} mediante documentos
...
4.6. **Energías renovables:**
	La PROVEEDORA se compromete con {genre.elCliente} a que
...
4.7. **Reducción y tratamiento de residuos e impacto ambiental:**
	...
	La PROVEEDORA se compromete, si se lo pidiera {genre.elCliente},
	a dar utilidad en la instalación a los dispositivos electrónicos de los que ya disponga {genre.elCliente},
...
4.8. **Economía local:**
	La PROVEEDORA se compromete con {genre.elCliente} a potenciar la economía local.
	...
	La PROVEEDORA se compromete con {genre.elCliente} a no deslocalizar trabajo remunerado,
...
4.9. **Trabajo digno:**
	La PROVEEDORA se compromete a que los trabajadores que dan el servicio {genre.alCliente}
...
4.10. **Participación y formación:**
	...
	Para tal fin, la PROVEEDORA fomentará la autoorganizacion democrática {genre.delCliente} con otros clientes,
...
Como contraprestación de los servicios prestados por la PROVEEDORA, {genre.elCliente} abonará
las tarifas adjuntas al presente contrato y que {genre.elCliente} reconoce conocer y haber recibido
en el momento de su firma.

La PROVEEDORA podrá variar las tarifas para adaptarlas por necesidades del mercado,
previa notificacion {genre.alCliente} mínimo un mes antes de la emisión de la primera factura
en la que tengan efecto las nuevas tarifas.
Una vez notificadas las nuevas tarifas se entienden aceptadas por {genre.elCliente} tácitamente.

La PROVEEDORA facturará, trimestralmente y a trimestre vista,
{genre.alCliente} la cuota pactada incrementada con el IVA.
...
6.2.
	...
	envío de correo electrónico {proveedor.contact.email[1]}.
...
6.4.
	...
	las incidencias que, en el marco de la prestación de los Servicios, afectan significativamente {genre.alCliente}.

6.5.
	Se entiende por *incidencia grave*:
	las incidencias que, en el marco de la prestación de los Servicios, afectan moderadamente {genre.alCliente}.
...
En caso de que se hubiera producido un impago por parte {genre.delCliente},
o en caso de que la PROVEEDORA constate que {genre.elCliente} incumple alguna de las clausulas de este Contrato,
...
{genre.ElCliente} tiene derecho a solicitar y obtener de la PROVEEDORA la suspensión temporal del servicio
...
no existiendo en ningún caso vínculo laboral alguno entre {genre.elCliente}
...
\doubleSignature{{ {genre.ELCLIENTE} }}{{ LA PROVEEDORA }}{{ {lugar} }}{{{fecha.dia} de {fecha.mes} de {fecha.any}}}
