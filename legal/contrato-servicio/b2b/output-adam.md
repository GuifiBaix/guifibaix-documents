...
para el correcto funcionamiento del sistema instalado en el CLIENTE,
...
2.2.2. El CLIENTE facilitará la labor de la PROVEEDORA en todo momento
...
por la incorrecta manipulación de los componentes realizados por el CLIENTE o terceros no vinculados.

2.2.4. El CLIENTE se compromete a utilizar
